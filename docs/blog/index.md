...
### [HuggingArch: Automating Model Architecture Analysis](/blog/huggingarch)
...
### [GPU-to-GPU Copy over PCIe: From cudaMemcpyAsync to a Custom Kernel](/blog/gpu-d2d-pcie)
...
### [GPU Clock Throttling: Why You Never Reach Peak FLOPS](/blog/gpu-throttling)
...
### [DeepSeek V3/R1 Inference Efficiency (1): A Back-of-the-Envelope Decoding Throughput Ceiling](/blog/ds-inference-1-throughput-ceiling)
...
### [DeepSeek V3/R1 Inference Efficiency (2): Reverse-Engineering the Production Deployment](/blog/ds-inference-2-reverse-engineering)
...
### [DeepSeek V3/R1 Inference Efficiency (3): Generalizing the Decode Configuration](/blog/ds-inference-3-decode-generalization)
