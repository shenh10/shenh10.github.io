...
Tsinghua University — Electronic Engineering (BSc) and the Institute for Interdisciplinary Information Sciences (MSc). Since then: computer vision at Horizon Robotics, then AI infrastructure at a GPU startup and at Kuaishou. Full background on the [about page](/en/about).
